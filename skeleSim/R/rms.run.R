...
#'   a rmetasim run.
#'
#' @importFrom rmetasim is.landscape landscape.simulate landscape.sample
#' @export
#'
...
#      init.pop.sizes = sc@simulator.params@init.pop.sizes,
      init.pop.sizes = round(sum(sc@pop.size)*rep(1/(sc@num.pops*sc@simulator.params@num.stgs),sc@num.pops*sc@simulator.params@num.stgs)),
